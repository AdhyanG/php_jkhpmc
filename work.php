...
<body>
        ...
        <div class="col-lg-7">
          ...
          <?php
             ...
             while($post=mysqli_fetch_assoc($runSql))
             {
              ...
              ?>
               <p class="mb-4 card-text" style="text-align: justify;"><?=$post['content']?> </p>
      ...
      <div class="row gx-5">
          ...
          <div class="row gx-5">
            ...
            <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
              ...
              <div class="link-animated d-flex flex-column justify-content-start">
                <a class="text-light mb-2" href="index.php"><i class="bi bi-arrow-right " style="color:brown">
                  </i>Home</a>
        ...
        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
          ...
          <div class="link-animated d-flex flex-column justify-content-start">
            ...
            <a class="text-light mb-2" href="https://jkgad.nic.in/"><i class="bi bi-arrow-right " style="color:brown">
              </i>General Administartion Department</a>
            <a class="text-light mb-2" href="http://www.hortijmu.jk.gov.in/"><i class="bi bi-arrow-right "
                style="color:brown">
              </i>Directorate of Horticulture Jammu</a>
            <a class="text-light mb-2" href="https://hortikashmir.gov.in/"><i class="bi bi-arrow-right "
                style="color:brown">
              </i>Directorate of Horticulture Kashmir</a>
            <a class="text-light mb-2" href="http://jkdhpm.in/index.aspx"><i class="bi bi-arrow-right "
                style="color:brown">
              </i>Directorate of Horticulture(P&M) J&K</a>
            <a class="text-light" href="https://nhb.gov.in/default.aspx"><i class="bi bi-arrow-right "
                style="color:brown">
  ...
  <!-- Back to Top -->
  <a href="#" class="btn btn-lg  btn-lg-square rounded back-to-top" style="color:red; background-color: yellowgreen;"><i
